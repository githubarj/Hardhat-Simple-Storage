...
This project demonstrates a basic Hardhat use case. It comes with simple smart contract, a test for that contract, a script that deploys that contract, and an example of a task implementation, which simply lists the available accounts.
...
```
git clone https://github.com/githubarj/Hardhat-Simple-Storage.git
